...
exports.migrateLegacyFoldersToRouteTree = migrateLegacyFoldersToRouteTree;
exports.migrateRouteTreeToLegacyFolders = migrateRouteTreeToLegacyFolders;
exports.applyCustomIndexesToRouteTree = applyCustomIndexesToRouteTree;
/**
 ...
 */
function migrateLegacyFoldersToRouteTree(legacyFolders) {
    const roots = [];
 ...
 */
function migrateRouteTreeToLegacyFolders(routeTree, vpsId) {
    const folders = [];
 ...
 */
function applyCustomIndexesToRouteTree(routeTree, customIndexes) {
