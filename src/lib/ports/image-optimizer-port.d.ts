...
export interface ImageOptimizerPort {
     ...
     */
    optimize(content: Uint8Array, filename: string, config?: Partial<ImageOptimizationConfig>): Promise<OptimizedImage>;
    /**
...
//# sourceMappingURL=image-optimizer-port.d.ts.map