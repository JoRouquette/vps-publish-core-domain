...
export interface AssetValidatorPort {
     ...
     */
    validate(buffer: Buffer | Uint8Array, filename: string, clientMimeType?: string, maxSizeBytes?: number): Promise<AssetValidationResult>;
}
...
//# sourceMappingURL=asset-validator-port.d.ts.map